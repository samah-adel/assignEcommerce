    ...
    return (
        <>
            {loading ? (
                ...
                <Toaster />
                <form className="max-w-5xl mx-auto mt-40">
                ...
                <div className='w-10/12 mx-auto my-5'>
                    <div className='flex flex-wrap'>
                        {filteredProducts.map((product) => {
                            ...
                            let { name } = category;
                            return (
                                <div key={_id} className='lg:w-3/12 md:w-3/12 sm:w-6/12 w-full group px-3 mb-3'>
                                    <div className='item p-5 hover:border overflow-hidden hover:shadow-md hover:shadow-green-500 '>
